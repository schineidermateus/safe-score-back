...
#[ORM\UniqueConstraint(name: 'uniq_material_org_code', columns: ['organization_id', 'code'])]
class Material
{
    ...
    public static function create(Organization $organization, string $code, string $name, \DateTimeImmutable $now): self
    {
        $e = new self();
